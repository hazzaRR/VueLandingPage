    ...
    <footer class="bg-primary">
      <div class="container px-6 py-8 mx-auto space-y-8 lg:space-y-0 lg:flex lg:justify-between">
        <div>
          ...
          <p class="max-w-lg mt-6 leading-relaxed text-neutral">
            Local Jewellery business based in Lawford, Manningtree
          </p>
        </div>
        ...
        <div>
          ...
          <div class="flex mt-6 -mx-4">
            <a class="mx-4 text-neutral hover:text-content" href="#">
      ...
      <p class="w-full py-6 mx-auto text-neutral text-center bg-secondary">
        &copy; 2024 Moomoo Jewellery. All rights reserved.
      </p>
    </footer>
