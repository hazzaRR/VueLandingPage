<template>  
    <section class="container flex flex-col items-center px-6 py-12 mx-auto lg:flex-row">
        ...
        <div class="h-[38rem] mt-12 lg:mt-0 w-full mx-auto max-w-md overflow-hidden rounded-t-full outline outline-4 outline-offset-4 outline-[#243458]/40">
    ...
    <section class="container px-6 py-12 mx-auto lg:py-16">
      <h3 class="font-serif text-3xl text-[#243458] capitalize md:text-4xl lg:text-5xl">
        News & Updates
      </h3>
