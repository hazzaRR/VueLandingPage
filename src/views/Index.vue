<template>  
    <section class="container flex flex-col items-center px-6 py-12 mx-auto lg:flex-row">
        <div class="lg:w-1/2">
          <h1 class="max-w-xl font-serif text-4xl font-medium tracking-wide text-primary capitalize md:text-6xl ">Beauty awaits</h1>
  
          <p class="max-w-lg mt-4 text-content">Lorem ipsum dolor sit amet consectetur adipisicing elit. At magnam voluptatibus perferendis odit optio.</p>
          
          <div class="mt-6 sm:flex sm:items-center">
            <router-link to="/price-list" class="bg-primary hover:bg-primary/80 duration-300 transition-colors border-2 border-primary px-6 block text-center py-3 uppercase text-sm font-bold leading-4 tracking-widest text-content">
              Price List
            </router-link>
  
            <router-link to="/contact" class="border-2 text-sm duration-300 transition-colors bg-primary hover:bg-primary/80 font-bold leading-4 mt-4 sm:mt-0 tracking-widest text-content sm:mx-4 border-primary px-6 block text-center py-3 uppercase">
              Contact
            </router-link>
          </div>
        </div>
  
        <div class="h-[38rem] mt-12 lg:mt-0 w-full mx-auto max-w-md overflow-hidden rounded-t-full outline outline-4 outline-offset-4 outline-primary/40">
    ...
    <section class="bg-primary mt-12">
      <div class="container flex flex-col px-6 py-16 mx-auto mt-12">
        <div class="order-2 mt-8 lg:order-1 lg:mt-0 lg:flex lg:items-center lg:-mx-6">
          ...
          <div class="mt-8 lg:w-1/2 lg:mx-6 lg:mt-0">
            <h3 class="font-serif text-2xl text-content capitalize md:text-4xl lg:text-5xl">
            ...
            <router-link class="inline-flex px-6 py-3 mt-6 text-white border-2 border-white hover:bg-white duration-300 transition-colors" to="/gallery">
              See More
            </router-link>
          </div>
        </div>
    ...
    <section class="container px-6 py-12 mx-auto lg:py-16">
      <h3 class="font-serif text-3xl text-content capitalize md:text-4xl lg:text-5xl">
        News & Updates
      </h3>
      ...
      <div class="mt-8 xl:-mx-6 xl:flex">
        <div class="xl:w-1/2 xl:mx-6">
          ...
          <h2 class="mt-6 font-serif text-3xl font-medium text-content">Now Accepting Card Payments</h2>
  
          <p class="mt-2 text-content">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Tincidunt facilisis nuncLorem ipsum dolor sit.Lorem ipsum dolor sit amet, consectetur adipiscing elit...</p>
  
          <p class="mt-4 italic text-content">December 23, 2021</p>
        </div>
