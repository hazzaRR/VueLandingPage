    ...
    <div class="container px-6 py-12 mx-auto">
        ...
        <div class="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-3">
            <div class="grid grid-cols-1 gap-12 sm:grid-cols-2 lg:grid-cols-1">
                <div>
                    <span class="inline-block p-3 text-[#243458] bg-blue-100/80">
                    ...
                    <p class="mt-2 text-sm text-[#243458]">example@email.com</p>
                </div>

                <div>
                    <span class="inline-block p-3 tex-[#243458] bg-blue-100/80 ">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                    ...
                    <h2 class="mt-4 text-base font-medium text-gray-800 ">Salon</h2>
                ...
                <div>
                    ...
                    <p class="mt-2 text-sm text-[#243458]">+44 00000-000000</p>
                </div>
            </div>
